...
namespace Sources
{
    public class Test : MonoBehaviour
    {
        ...
        public static List<Matrix4x4> ParseJsonToMatrices(string jsonText)
        {
            // Обернем JSON в объект, если это массив
        ...
        public List<Matrix4x4> GetMatrix(string path)
        {
            ...
            if (File.Exists(jsonPath))
            {
                ...
                Debug.Log($"Successfully parsed {matrices.Count} matrices");
